...
{
    public interface IMaterialMasterTransitions : ITransitionsBase { }

    public class MaterialMasterTransitions : IMaterialMasterTransitions
    {
        ...
        {
            var sagaTransition = new MaterialMasterTransitionHistory
            {
                Id = Guid.NewGuid(),
                SagaId = sagaId,
                SagaName = sagaName,
