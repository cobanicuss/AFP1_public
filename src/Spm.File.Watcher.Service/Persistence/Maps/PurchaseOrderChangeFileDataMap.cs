...
{
    public class PurchaseOrderChangeFileDataMap : ClassMap<PurchaseOrderChangeFileData>
    {
        public PurchaseOrderChangeFileDataMap()
        {
            Table("PurchaseOrderChangeFileData");
            Id(x => x.DataId);
