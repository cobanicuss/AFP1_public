...
{
    public class MappingPurchaseOrderChange : IMapJdeToSapForPurchaseOrderChange
    {
        ...
        public MappingPurchaseOrderChange(ICacheMapRepository cacheMapRepository, IDoMappingBusinessRules mappingBusinessRules, IMapPayloads mapPayloads)
        {
        ...
        public MappingValidationPurchaseOrderDto ValidateMapping(IList<PurchaseOrderDto> input)
        {
            ...
            foreach (var inItem in input)
            {
                ...
                CreateMappingByItem(inItem, mappedItem, validationList, rowNumber);
        ...
        public PurchaseOrderChangeCommand MapPayload(IList<PurchaseOrderDto> input)
        {
            var output = new PurchaseOrderChangeCommand
            {
        ...
        private void CreateMappingByItem(PurchaseOrderDto inItem, PurchaseOrderDto outItem, ICollection<ValidationResult> validationList, int rowNumber)
        {
            ...
            var docTypeResult = _mappingBusinessRules.MapDocType(_docTypeMapping, MapDefaults.PurchaseOrderChange);
            ...
            outItem.ItemIntvl = MapDefaults.DefaultItemIntvlChange;
            ...
            outItem.NoMoreGr = inItem.NoMoreGr;
            ...
            outItem.SerialNo = MapDefaults.PurchaseOrderChangeSerialNo;
