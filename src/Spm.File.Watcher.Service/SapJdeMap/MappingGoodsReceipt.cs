...
{
    public class MappingGoodsReceipt : IMapJdeToSapForGoodsReceipt
    {
        ...
        public MappingGoodsReceipt(ICacheMapRepository cacheMapRepository, IDoMappingBusinessRules mappingBusinessRules, IMapPayloads mapPayloads)
        {
        ...
        private void CreateMappingByItem(GoodsDto inItem, GoodsDto outItem, ICollection<ValidationResult> validationList, int rowNumber)
        {
            ...
            outItem.MoveType = MapDefaults.GoodsReceiptType;
