...
{
    [TestFixture]
    public class MapOrderPrUnTest : MappingBusinessRulesTestBase
    {
        //IMPORTANT:
        //Same as MapPoUnitTest.
        //Explictly tested here because it is public 

        private const string Scenario = "Mapping of Order Pr-Unit";
        ...
        {
            _dto = ClassUnderTest.MapOrderPrUn(MapUnitOfMeasureList, PoUnit);
        }
    }
}