...
{
    [TestFixture]
    public class MapJdeToSapForPurchaseOrderChangeTest
    {
        private IMapJdeToSapForPurchaseOrderChange _classUnderTest;
        ...
        private PurchaseOrderChangeCommand _payloadOutput;

        [Test]
        public void JdeToSapMappingShouldBeDoneCorrectlyForPurchaseOrderChange()
        {
        ...
        private void MappingFromJdeToSap()
        {
            ...
            _classUnderTest = new MapJdeToSapForPurchaseOrderChange(_lineItemMapping.Object, _mapPayloads.Object);
        }
        ...
        {
            _lineItemMapping.Verify(x => x.ForPurchaseOrderChange(It.IsAny<PurchaseOrderDto>(), It.IsAny<List<ProblemDto>>(), It.IsAny<int>()));
        }
